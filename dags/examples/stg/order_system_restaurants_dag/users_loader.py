...
class UsersLoader:
    ...
    def __init__(self, collection_loader: UsersReader, pg_dest: PgConnect, users_pg_saver: UsersPgSaver, logger: Logger) -> None:
        self.collection_loader = collection_loader
        self.users_pg_saver = users_pg_saver
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            i = 0
            for d in load_queue:
                self.users_pg_saver.save_object(conn, str(d["_id"]), d["update_ts"], d)
